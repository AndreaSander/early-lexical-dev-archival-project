...
ggsave("predicted_values.png", dpi = "print", width = 14, height = 7, units = "in")
```
...
tc%>%
  ...
  scale_color_manual(name= "experience bins (%)", values = c("#feb24c", "#ef6548", "#d7301f", "#7f0000"))+
  theme_bw()+
...
ggsave("time_course.png", dpi = "print", width = 14, height = 7, units = "in")
