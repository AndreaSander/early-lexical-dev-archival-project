...
x.2 <- plot_model(lmm_viz_aditive, type="eff", terms = c("age_months[14,20, 26, 32, 38, 44, 48] ", "exp_target_lang_prop[1 , 0.75, 0.5, 0.25]"), line.size = 0.8, colors = c("#feb24c", "#ef6548", "#d7301f", "#7f0000"),
           legend.title = "Exposure to target language (proportion)", title = "Predicted values of looking accuracy for the additive model")
...
image_flatten(c(plot_2, plot_1), operator = "Add")
